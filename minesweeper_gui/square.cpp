// lisäsin neljä viimeistä metodia. Toteuttaa square-luokan metodit.´
// ---------------------------------------------------------------------
// Elias Keso / Norssi
// elias.keso@tuni.fi
// TUNI-tunnus: mrelke
...
Square::Square(int x, int y, bool mine, GameBoard* board):
    ...
    kysymysmerkki_(false), board_(board)
{
}
...
void Square::lisaaKysymysmerkki()
{
    kysymysmerkki_ = true;
}

void Square::poistaKysymysmerkki()
{
    kysymysmerkki_ = false;
}
