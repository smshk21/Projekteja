...
public:
    ...
    // Tyhjentää laudan tiedot uuden pelin aloittamista varten.
    void tyhjenna();
    ...
    // Returns the pointer to the square object in the given location.
    ...
    // Palauttaa tiedon siitä, onko lippuja väärissä paikoissa.
    bool liputOikein();
